(() => {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".menu__wrapper")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".menu__wrapper")) {
                    bodyLockToggle();
        ...
        if (parentContainer) for (const element of parentContainer) element.addEventListener("click", (event => {
            ...
            const isReadMoreBtn = current.className.includes("readmore__button");
